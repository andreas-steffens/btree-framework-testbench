/************************************************************
**
** file:	btreemaptestwrapper.cpp
** author:	Andreas Steffens
** license:	LGPL v3
**
** description:
**
** This file contains the definition of a map test class 
...
#ifndef	BTREEMAPTESTWRAPPER_CPP
#define	BTREEMAPTESTWRAPPER_CPP

#include "btreemaptestwrapper.h"

template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper (const uint32_t nNodeSize, const uint32_t nPageSize)
	:	CBTreeAssociativeTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container> (nNodeSize, nPageSize)
{
	this->m_nNumContainers = CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::m_nNumContainersM;
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper (const CBTreeMapTestWrapper &rContainer)
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper (CBTreeMapTestWrapper &&rRhsContainer)
	:	CBTreeAssociativeTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container> (rRhsContainer)
{
	...
	this->move_construct_containers (::std::forward<CBTreeMapTestWrapper_t> (rRhsContainer));
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::~CBTreeMapTestWrapper ()
{
}

template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
template<class _t_iterator>
void CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::insert (_t_iterator sIterFirst, _t_iterator sIterLast)
{
	uint32_t		i = 0;
	...
	BTREE_ASSERT (i == this->get_num_containers (), "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::insert<_t_iterator>: ERROR: Unexpected number of test containers!");
...
void CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::insert (_t_dummy_iterator &rIterDummy, _t_iterator sIterFirst, _t_iterator sIterLast)
{
	rIterDummy;
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
typename CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::iterator CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::insert (const typename CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::value_type &rData, const bool bInsertNotEmplace)
{
	return (CBTreeAssociativeTestWrapper_t::insert (rData, bInsertNotEmplace));
}

template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
void CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::insert_hint
	(
		const typename CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::value_type &rData, 
...
void CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::insert_self_reference (_t_iterator sIterFirst, _t_iterator sIterLast, _t_test_iterator &rIterTest)
{
	uint32_t			i = 0;
...
void CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::test_all_containers_insert (_t_ext_container *pExtContainer, _t_ext_iterator &rExtPos, _t_ref_iterator &rIterBegin, _t_ref_iterator &rIterFirst, _t_ref_iterator &rIterLast) const
{
...
void CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::emplace (_t_va_args && ... rrArgs)
{
	uint32_t								i = 0;
	_t_data									sInputData;
	...
	BTREE_ASSERT (i == this->get_num_containers (), "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::emplace<>: ERROR: Unexpected number of test containers!");
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
template<class ..._t_va_args>
void CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::emplace_hint
	(
		_t_va_args && ... rrArgs
	)
{
	...
	_t_data									sInputData;
	value_type								sRefData;
	::std::pair<iterator, bool>				sPairHint;
	iterator								sIterHint;
	iterator								sIterBegin;
	size_type								nDist;
	...
	sPairHint = this->m_pReference->emplace (sRefData);

	sIterHint = sPairHint.first;
	...
	BTREE_ASSERT (i == this->get_num_containers (), "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::emplace_hint<>: ERROR: Unexpected number of test containers!");

	this->test ();
}

template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
typename CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::key_compare CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::key_comp () const
{
	key_compare		sRetval;

	sRetval.m_pThis = (CBTreeMapTestWrapper_t *) this;

	return (sRetval);
}

template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
typename CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::value_compare CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::value_comp () const
{
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
bool CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::run_key_compare (const typename CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::key_type &rKey0, const typename CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::key_type &rKey1) const
{
	...
	for (i = 0; i < this->get_num_containers (); i++)
	{
		...
		{
			::std::cerr << "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::run_key_compare: ERROR: comparison result mismatch!" << ::std::endl;
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
bool CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::run_value_compare (const typename CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::value_type &rVal0, const typename CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::value_type &rVal1) const
{
	...
	for (i = 0; i < this->get_num_containers (); i++)
	{
		...
		if (bRefValue != bTestValue)
		{
			::std::cerr << "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::run_value_compare: ERROR: comparison result mismatch!" << ::std::endl;
...
CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::operator= (const CBTreeMapTestWrapper_t &rContainer)
{
	if (this != &rContainer)
	{
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container> &
CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::operator= (CBTreeMapTestWrapper_t &&rRhsContainer)
{
	CBTreeAssociativeTestWrapper_t		&rAssociativeTestWrapperThis = dynamic_cast<CBTreeAssociativeTestWrapper_t &> (*this);
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
void CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::init_containers (const uint32_t nNodeSize, const uint32_t nPageSize)
{
	...
	m_pContainerRAM6565_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sRAMprop6565, nNodeSize, this->m_pReference);
	m_pContainerRAM6555_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sRAMprop6555, nNodeSize, this->m_pReference);
	m_pContainerRAM5555_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sRAMprop5555, nNodeSize, this->m_pReference);
	m_pContainerRAM5554_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sRAMprop5554, nNodeSize, this->m_pReference);
	m_pContainerRAM5454_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sRAMprop5454, nNodeSize, this->m_pReference);
	m_pContainerRAM5444_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (sRAMprop5444, nNodeSize, this->m_pReference);
	m_pContainerRAM4444_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (sRAMprop4444, nNodeSize, this->m_pReference);
	m_pContainerRAM6565_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sRAMprop6565, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM6555_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sRAMprop6555, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM5555_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sRAMprop5555, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM5554_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sRAMprop5554, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM5454_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sRAMprop5454, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM5444_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (sRAMprop5444, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM4444_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (sRAMprop4444, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM6565_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sRAMprop6565, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM6555_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sRAMprop6555, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM5555_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sRAMprop5555, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM5554_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sRAMprop5554, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM5454_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sRAMprop5454, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM5444_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (sRAMprop5444, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM4444_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (sRAMprop4444, nNodeSize * 4, this->m_pReference);
	m_pContainerFile6565min = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sFilePropertiesMin6565, nNodeSize * 4, this->m_pReference);
	m_pContainerFile6555min = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesMin6555, nNodeSize * 8, this->m_pReference);
	m_pContainerFile5555min = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesMin5555, nNodeSize * 7, this->m_pReference);
	m_pContainerFile5554min = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sFilePropertiesMin5554, nNodeSize * 6, this->m_pReference);
	m_pContainerFile5454min = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sFilePropertiesMin5454, nNodeSize * 5, this->m_pReference);

	m_pContainerFile6565default = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sFilePropertiesDefault6565, nNodeSize * 3, this->m_pReference);
	m_pContainerFile6555default = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesDefault6555, nNodeSize * 2, this->m_pReference);
	m_pContainerFile5555default = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesDefault5555, nNodeSize, this->m_pReference);
	m_pContainerFile5554default = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sFilePropertiesDefault5554, nNodeSize * 8, this->m_pReference);
	m_pContainerFile5454default = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sFilePropertiesDefault5454, nNodeSize * 7, this->m_pReference);

	m_pContainerFile6565large = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sFilePropertiesLarge6565, nNodeSize * 5, this->m_pReference);
	m_pContainerFile6555large = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesLarge6555, nNodeSize * 4, this->m_pReference);
	m_pContainerFile5555large = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesLarge5555, nNodeSize * 3, this->m_pReference);
	m_pContainerFile5554large = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sFilePropertiesLarge5554, nNodeSize * 2, this->m_pReference);
	m_pContainerFile5454large = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sFilePropertiesLarge5454, nNodeSize, this->m_pReference);

	BTREE_ASSERT (NULL != m_pContainerRAM6565_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM6565_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM6555_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM6555_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5555_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5555_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5554_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5554_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5454_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5454_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5444_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5444_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM4444_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM4444_n)");
	BTREE_ASSERT (NULL != m_pContainerRAM6565_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM6565_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM6555_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM6555_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5555_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5555_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5554_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5554_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5454_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5454_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5444_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5444_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM4444_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM4444_2n)");
	BTREE_ASSERT (NULL != m_pContainerRAM6565_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM6565_4n)");
	BTREE_ASSERT (NULL != m_pContainerRAM6555_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM6555_4n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5555_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5555_4n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5554_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5554_4n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5454_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5454_4n)");
	BTREE_ASSERT (NULL != m_pContainerRAM5444_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5444_4n)");
	BTREE_ASSERT (NULL != m_pContainerRAM4444_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM4444_4n)");
	BTREE_ASSERT (NULL != m_pContainerFile6565min, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile6565min)");
	BTREE_ASSERT (NULL != m_pContainerFile6555min, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile6555min)");
	BTREE_ASSERT (NULL != m_pContainerFile5555min, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5555min)");
	BTREE_ASSERT (NULL != m_pContainerFile5554min, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5554min)");
	BTREE_ASSERT (NULL != m_pContainerFile5454min, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5454min)");

	BTREE_ASSERT (NULL != m_pContainerFile6565default, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile6565default)");
	BTREE_ASSERT (NULL != m_pContainerFile6555default, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile6555default)");
	BTREE_ASSERT (NULL != m_pContainerFile5555default, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5555default)");
	BTREE_ASSERT (NULL != m_pContainerFile5554default, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5554default)");
	BTREE_ASSERT (NULL != m_pContainerFile5454default, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5454default)");

	BTREE_ASSERT (NULL != m_pContainerFile6565large, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile6565large)");
	BTREE_ASSERT (NULL != m_pContainerFile6555large, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile6555large)");
	BTREE_ASSERT (NULL != m_pContainerFile5555large, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5555large)");
	BTREE_ASSERT (NULL != m_pContainerFile5554large, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5554large)");
	BTREE_ASSERT (NULL != m_pContainerFile5454large, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5454large)");
}

template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
void CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::init_containers (const CBTreeAssociativeTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container> &rWrapper, const bool bAssign)
{
	uint32_t	i = 0;

	const CBTreeMapTestWrapper_t		&rThisWrapper = dynamic_cast<const CBTreeMapTestWrapper_t &> (rWrapper);

	m_pContainerRAM6565_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6565_n, bAssign); i++;
	m_pContainerRAM6555_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6555_n, bAssign); i++;
	m_pContainerRAM5555_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM5555_n, bAssign); i++;
	m_pContainerRAM5554_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5554_n, bAssign); i++;
	m_pContainerRAM5454_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5454_n, bAssign); i++;
	m_pContainerRAM5444_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5444_n, bAssign); i++;
	m_pContainerRAM4444_n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM4444_n, bAssign); i++;
	m_pContainerRAM6565_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6565_2n, bAssign); i++;
	m_pContainerRAM6555_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6555_2n, bAssign); i++;
	m_pContainerRAM5555_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM5555_2n, bAssign); i++;
	m_pContainerRAM5554_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5554_2n, bAssign); i++;
	m_pContainerRAM5454_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5454_2n, bAssign); i++;
	m_pContainerRAM5444_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5444_2n, bAssign); i++;
	m_pContainerRAM4444_2n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM4444_2n, bAssign); i++;
	m_pContainerRAM6565_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6565_4n, bAssign); i++;
	m_pContainerRAM6555_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6555_4n, bAssign); i++;
	m_pContainerRAM5555_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM5555_4n, bAssign); i++;
	m_pContainerRAM5554_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5554_4n, bAssign); i++;
	m_pContainerRAM5454_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5454_4n, bAssign); i++;
	m_pContainerRAM5444_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5444_4n, bAssign); i++;
	m_pContainerRAM4444_4n = new CBTreeTestMap<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM4444_4n, bAssign); i++;
	m_pContainerFile6565min = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerFile6565min, bAssign); i++;
	m_pContainerFile6555min = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile6555min, bAssign); i++;
	m_pContainerFile5555min = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile5555min, bAssign); i++;
	m_pContainerFile5554min = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5554min, bAssign); i++;
	m_pContainerFile5454min = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5454min, bAssign); i++;

	m_pContainerFile6565default = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerFile6565default, bAssign); i++;
	m_pContainerFile6555default = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile6555default, bAssign); i++;
	m_pContainerFile5555default = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile5555default, bAssign); i++;
	m_pContainerFile5554default = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5554default, bAssign); i++;
	m_pContainerFile5454default = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5454default, bAssign); i++;

	m_pContainerFile6565large = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerFile6565large, bAssign); i++;
	m_pContainerFile6555large = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile6555large, bAssign); i++;
	m_pContainerFile5555large = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile5555large, bAssign); i++;
	m_pContainerFile5554large = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5554large, bAssign); i++;
	m_pContainerFile5454large = new CBTreeTestMap<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5454large, bAssign); i++;

	BTREE_ASSERT (i == this->get_num_containers (), "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::init_container (const CBTreeAssociativeTestWrapper &): ERROR: Unexpected number of test containers instantiated!");

	i = 0;

	BTREE_ASSERT (NULL != m_pContainerRAM6565_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM6565_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM6555_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM6555_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5555_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5555_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5554_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5554_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5454_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5454_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5444_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5444_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM4444_n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM4444_n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM6565_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM6565_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM6555_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM6555_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5555_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5555_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5554_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5554_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5454_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5454_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5444_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5444_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM4444_2n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM4444_2n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM6565_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM6565_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM6555_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM6555_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5555_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5555_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5554_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5554_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5454_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5454_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM5444_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM5444_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerRAM4444_4n, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerRAM4444_4n)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile6565min, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile6565min)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile6555min, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile6555min)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5555min, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5555min)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5554min, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5554min)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5454min, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5454min)"); i++;

	BTREE_ASSERT (NULL != m_pContainerFile6565default, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile6565default)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile6555default, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile6555default)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5555default, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5555default)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5554default, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5554default)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5454default, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5454default)"); i++;

	BTREE_ASSERT (NULL != m_pContainerFile6565large, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile6565large)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile6555large, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile6555large)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5555large, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5555large)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5554large, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5554large)"); i++;
	BTREE_ASSERT (NULL != m_pContainerFile5454large, "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: insufficient memory! (m_pContainerFile5454large)"); i++;

	BTREE_ASSERT (i == this->get_num_containers (), "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::init_container (const CBTreeAssociativeTestWrapper &): ERROR: Unexpected number of test containers checked to be instantiated successfully!");
	...
	BTREE_ASSERT (i == this->get_num_containers (), "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::init_container (const CBTreeAssociativeTestWrapper &): ERROR: Unexpected number of test containers after setting reference container!");
}

template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
void CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::transfer_containers ()
{
	uint32_t		i = 0;
	...
	BTREE_ASSERT (i == this->get_num_containers (), "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeMapTestWrapper: ERROR: Unexpected number of test containers!");
}

template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
template<class _t_ext_container, class _t_source_container, class _t_ext_sizetype, class _t_ext_iterator>
void CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::test_one_container_insert (_t_ext_container *pExtOriginal, _t_ext_container *pExtReference, _t_ext_sizetype nPos, typename CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::size_test_type nFirst, typename CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::size_test_type nLast, _t_ext_iterator &rExtIter, bool bRefIterConst, bool bRefIterReverse, _t_source_container *pSrc) const
{
//#if defined (_MSC_VER)
...
void CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::test_one_container_insert (_t_ext_container *pExtOriginal, _t_ext_container *pExtReference, _t_ext_sizetype nPos, typename CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::size_test_type nFirst, typename CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::size_test_type nLast, _t_ext_iterator &rExtIter, _t_iterator &rIter, _t_source_container *pSrc) const
{
	...
	{
		::std::cerr << "CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::test_one_container_insert: ERROR: size mismatch!" << ::std::endl << ::std::flush;
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
void CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::move_construct_containers (CBTreeMapTestWrapper_t &&rRhsContainer)
{
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
const uint32_t CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::m_nNumContainersM = 36;
