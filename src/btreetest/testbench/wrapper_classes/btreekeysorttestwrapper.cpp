...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
CBTreeKeySortTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeKeySortTestWrapper (CBTreeKeySortTestWrapper &&rRhsContainer)
	:	CBTreeAssociativeTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container> (rRhsContainer)
{
	...
	this->move_construct_containers (::std::forward<CBTreeKeySortTestWrapper_t> (rRhsContainer));
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
void CBTreeKeySortTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::init_containers (const CBTreeAssociativeTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container> &rWrapper, const bool bAssign)
{
	uint32_t	i = 0;

	const CBTreeKeySortTestWrapper_t		&rThisWrapper = dynamic_cast<const CBTreeKeySortTestWrapper_t &> (rWrapper);

	m_pContainerRAM6565_n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6565_n, bAssign); i++;
	m_pContainerRAM6555_n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6555_n, bAssign); i++;
	m_pContainerRAM5555_n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM5555_n, bAssign); i++;
	m_pContainerRAM5554_n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5554_n, bAssign); i++;
	m_pContainerRAM5454_n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5454_n, bAssign); i++;
	m_pContainerRAM5444_n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5444_n, bAssign); i++;
	m_pContainerRAM4444_n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM4444_n, bAssign); i++;
	m_pContainerRAM6565_2n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6565_2n, bAssign); i++;
	m_pContainerRAM6555_2n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6555_2n, bAssign); i++;
	m_pContainerRAM5555_2n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM5555_2n, bAssign); i++;
	m_pContainerRAM5554_2n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5554_2n, bAssign); i++;
	m_pContainerRAM5454_2n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5454_2n, bAssign); i++;
	m_pContainerRAM5444_2n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5444_2n, bAssign); i++;
	m_pContainerRAM4444_2n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM4444_2n, bAssign); i++;
	m_pContainerRAM6565_4n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6565_4n, bAssign); i++;
	m_pContainerRAM6555_4n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6555_4n, bAssign); i++;
	m_pContainerRAM5555_4n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM5555_4n, bAssign); i++;
	m_pContainerRAM5554_4n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5554_4n, bAssign); i++;
	m_pContainerRAM5454_4n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5454_4n, bAssign); i++;
	m_pContainerRAM5444_4n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5444_4n, bAssign); i++;
	m_pContainerRAM4444_4n = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM4444_4n, bAssign); i++;
	m_pContainerFile6565min = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerFile6565min, bAssign); i++;
	m_pContainerFile6555min = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile6555min, bAssign); i++;
	m_pContainerFile5555min = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile5555min, bAssign); i++;
	m_pContainerFile5554min = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5554min, bAssign); i++;
	m_pContainerFile5454min = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5454min, bAssign); i++;

	m_pContainerFile6565default = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerFile6565default, bAssign); i++;
	m_pContainerFile6555default = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile6555default, bAssign); i++;
	m_pContainerFile5555default = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile5555default, bAssign); i++;
	m_pContainerFile5554default = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5554default, bAssign); i++;
	m_pContainerFile5454default = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5454default, bAssign); i++;

	m_pContainerFile6565large = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerFile6565large, bAssign); i++;
	m_pContainerFile6555large = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile6555large, bAssign); i++;
	m_pContainerFile5555large = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile5555large, bAssign); i++;
	m_pContainerFile5554large = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5554large, bAssign); i++;
	m_pContainerFile5454large = new CBTreeKeySortTest<value_test_type, uint32_t, CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5454large, bAssign); i++;
...
CBTreeKeySortTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::operator= (const CBTreeKeySortTestWrapper_t &rContainer)
{
	if (this != &rContainer)
	{
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
CBTreeKeySortTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container> &
CBTreeKeySortTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::operator= (CBTreeKeySortTestWrapper_t &&rRhsContainer)
{
	CBTreeAssociativeTestWrapper_t		&rAssociativeTestWrapperThis = dynamic_cast<CBTreeAssociativeTestWrapper_t &> (*this);
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
void CBTreeKeySortTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::move_construct_containers (CBTreeKeySortTestWrapper_t &&rRhsContainer)
{
