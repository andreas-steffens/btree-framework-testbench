...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::CBTreeSetTestWrapper (CBTreeSetTestWrapper &&rRhsContainer)
	:	CBTreeAssociativeTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container> (rRhsContainer)
{
	...
	this->move_construct_containers (::std::forward<CBTreeSetTestWrapper_t> (rRhsContainer));
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
typename CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::iterator CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::insert (const typename CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::value_type &rData, const bool bInsertNotEmplace)
{
	return (CBTreeAssociativeTestWrapper_t::insert (rData, bInsertNotEmplace));
}

template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
void CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::insert_hint
	(
		const typename CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::value_type &rData, 
...
void CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::emplace (_t_va_args && ... rrArgs)
{
	uint32_t								i = 0;
	_t_data									sInputData;
	...
	BTREE_ASSERT (i == this->get_num_containers (), "CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::emplace<>: ERROR: Unexpected number of test containers!");
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
template<class ..._t_va_args>
void CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::emplace_hint
	(
		_t_va_args && ... rrArgs
	)
{
	...
	BTREE_ASSERT (i == this->get_num_containers (), "CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::emplace_hint<>: ERROR: Unexpected number of test containers!");
...
CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::operator= (const CBTreeSetTestWrapper_t &rContainer)
{
	if (this != &rContainer)
	{
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container> &
CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::operator= (CBTreeSetTestWrapper_t &&rRhsContainer)
{
	CBTreeAssociativeTestWrapper_t		&rAssociativeTestWrapperThis = dynamic_cast<CBTreeAssociativeTestWrapper_t &> (*this);
...
void CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::init_containers (const uint32_t nNodeSize, const uint32_t nPageSize)
{
	...
	m_pContainerRAM6565_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sRAMprop6565, nNodeSize, this->m_pReference);
	m_pContainerRAM6555_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sRAMprop6555, nNodeSize, this->m_pReference);
	m_pContainerRAM5555_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sRAMprop5555, nNodeSize, this->m_pReference);
	m_pContainerRAM5554_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sRAMprop5554, nNodeSize, this->m_pReference);
	m_pContainerRAM5454_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sRAMprop5454, nNodeSize, this->m_pReference);
	m_pContainerRAM5444_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (sRAMprop5444, nNodeSize, this->m_pReference);
	m_pContainerRAM4444_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (sRAMprop4444, nNodeSize, this->m_pReference);
	m_pContainerRAM6565_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sRAMprop6565, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM6555_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sRAMprop6555, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM5555_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sRAMprop5555, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM5554_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sRAMprop5554, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM5454_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sRAMprop5454, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM5444_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (sRAMprop5444, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM4444_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (sRAMprop4444, nNodeSize * 2, this->m_pReference);
	m_pContainerRAM6565_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sRAMprop6565, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM6555_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sRAMprop6555, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM5555_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sRAMprop5555, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM5554_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sRAMprop5554, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM5454_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sRAMprop5454, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM5444_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (sRAMprop5444, nNodeSize * 4, this->m_pReference);
	m_pContainerRAM4444_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (sRAMprop4444, nNodeSize * 4, this->m_pReference);
	m_pContainerFile6565min = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sFilePropertiesMin6565, nNodeSize * 4, this->m_pReference);
	m_pContainerFile6555min = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesMin6555, nNodeSize * 8, this->m_pReference);
	m_pContainerFile5555min = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesMin5555, nNodeSize * 7, this->m_pReference);
	m_pContainerFile5554min = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sFilePropertiesMin5554, nNodeSize * 6, this->m_pReference);
	m_pContainerFile5454min = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sFilePropertiesMin5454, nNodeSize * 5, this->m_pReference);

	m_pContainerFile6565default = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sFilePropertiesDefault6565, nNodeSize * 3, this->m_pReference);
	m_pContainerFile6555default = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesDefault6555, nNodeSize * 2, this->m_pReference);
	m_pContainerFile5555default = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesDefault5555, nNodeSize, this->m_pReference);
	m_pContainerFile5554default = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sFilePropertiesDefault5554, nNodeSize * 8, this->m_pReference);
	m_pContainerFile5454default = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sFilePropertiesDefault5454, nNodeSize * 7, this->m_pReference);

	m_pContainerFile6565large = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (sFilePropertiesLarge6565, nNodeSize * 5, this->m_pReference);
	m_pContainerFile6555large = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesLarge6555, nNodeSize * 4, this->m_pReference);
	m_pContainerFile5555large = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (sFilePropertiesLarge5555, nNodeSize * 3, this->m_pReference);
	m_pContainerFile5554large = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (sFilePropertiesLarge5554, nNodeSize * 2, this->m_pReference);
	m_pContainerFile5454large = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (sFilePropertiesLarge5454, nNodeSize, this->m_pReference);
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
void CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::init_containers (const CBTreeAssociativeTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container> &rWrapper, const bool bAssign)
{
	uint32_t	i = 0;

	const CBTreeSetTestWrapper_t		&rThisWrapper = dynamic_cast<const CBTreeSetTestWrapper_t &> (rWrapper);

	m_pContainerRAM6565_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6565_n, bAssign); i++;
	m_pContainerRAM6555_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6555_n, bAssign); i++;
	m_pContainerRAM5555_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM5555_n, bAssign); i++;
	m_pContainerRAM5554_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5554_n, bAssign); i++;
	m_pContainerRAM5454_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5454_n, bAssign); i++;
	m_pContainerRAM5444_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5444_n, bAssign); i++;
	m_pContainerRAM4444_n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM4444_n, bAssign); i++;
	m_pContainerRAM6565_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6565_2n, bAssign); i++;
	m_pContainerRAM6555_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6555_2n, bAssign); i++;
	m_pContainerRAM5555_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM5555_2n, bAssign); i++;
	m_pContainerRAM5554_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5554_2n, bAssign); i++;
	m_pContainerRAM5454_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5454_2n, bAssign); i++;
	m_pContainerRAM5444_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5444_2n, bAssign); i++;
	m_pContainerRAM4444_2n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM4444_2n, bAssign); i++;
	m_pContainerRAM6565_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6565_4n, bAssign); i++;
	m_pContainerRAM6555_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM6555_4n, bAssign); i++;
	m_pContainerRAM5555_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerRAM5555_4n, bAssign); i++;
	m_pContainerRAM5554_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5554_4n, bAssign); i++;
	m_pContainerRAM5454_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5454_4n, bAssign); i++;
	m_pContainerRAM5444_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint32_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM5444_4n, bAssign); i++;
	m_pContainerRAM4444_4n = new CBTreeTestSet<CBTreeIOpropertiesRAM <size_test_type, uint16_t, uint16_t, uint16_t, uint16_t> > (*rThisWrapper.m_pContainerRAM4444_4n, bAssign); i++;
	m_pContainerFile6565min = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerFile6565min, bAssign); i++;
	m_pContainerFile6555min = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile6555min, bAssign); i++;
	m_pContainerFile5555min = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile5555min, bAssign); i++;
	m_pContainerFile5554min = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5554min, bAssign); i++;
	m_pContainerFile5454min = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5454min, bAssign); i++;

	m_pContainerFile6565default = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerFile6565default, bAssign); i++;
	m_pContainerFile6555default = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile6555default, bAssign); i++;
	m_pContainerFile5555default = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile5555default, bAssign); i++;
	m_pContainerFile5554default = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5554default, bAssign); i++;
	m_pContainerFile5454default = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5454default, bAssign); i++;

	m_pContainerFile6565large = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint64_t, uint32_t> > (*rThisWrapper.m_pContainerFile6565large, bAssign); i++;
	m_pContainerFile6555large = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint64_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile6555large, bAssign); i++;
	m_pContainerFile5555large = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint32_t> > (*rThisWrapper.m_pContainerFile5555large, bAssign); i++;
	m_pContainerFile5554large = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint32_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5554large, bAssign); i++;
	m_pContainerFile5454large = new CBTreeTestSet<CBTreeIOpropertiesFile <size_test_type, uint32_t, uint16_t, uint32_t, uint16_t> > (*rThisWrapper.m_pContainerFile5454large, bAssign); i++;
...
template<class _t_data, class _t_value, class _t_sizetype, class _t_ref_container>
void CBTreeSetTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>::move_construct_containers (CBTreeSetTestWrapper_t &&rRhsContainer)
{
