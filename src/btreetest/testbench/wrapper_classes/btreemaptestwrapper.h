...
public:
	...
	typedef struct value_compare_s<value_type>					value_compare;
							...
							CBTreeMapTestWrapper<_t_data, _t_value, _t_sizetype, _t_ref_container>
																(CBTreeMapTestWrapper &&rRhsContainer);
	...
	CBTreeMapTestWrapper &	operator=							(const CBTreeMapTestWrapper &rContainer);

	CBTreeMapTestWrapper &	operator=							(CBTreeMapTestWrapper &&rRhsContainer);
...
protected:
	...
	void					move_construct_containers			(CBTreeMapTestWrapper &&rRhsContainer);
